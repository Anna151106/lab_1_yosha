...
using DormInfrastructure.Models; // Простір імен для твоєї моделі ApplicationUser
using Microsoft.AspNetCore.Identity.EntityFrameworkCore; // Підключили Identity

namespace DormInfrastructure;

// Змінили наслідування з DbContext на IdentityDbContext<ApplicationUser>
public partial class DbDormContext : IdentityDbContext<ApplicationUser>
{
    ...
    {
        // Обов'язково викликаємо базову конфігурацію Identity таблиць
